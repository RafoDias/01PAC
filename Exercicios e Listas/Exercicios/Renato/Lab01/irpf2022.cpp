...
// Após compilar o programa, você pdoe testá-lo normalmente ou usando o comando:

//  WINDOWS: Get-Content salarios.txt | ./irpf2022
//  LINUX : ./irpf2022 < salarios.txt

// Caso queira criar um arquivo de saída, é só adicionar "> saida.txt" no final do comando:
//  Get-Content salarios.txt | ./irpf2022 > impostos.txt
...
int main()
{
    ...
    {
        count++;
        cout << "Entrada " << count << ", Salario: " << salario << endl;
